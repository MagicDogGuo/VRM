...
public class MineControlScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        neck_quat = Quaternion.Euler(0,0, 0);/////////////////////////////
    ...
    void Update()
    {
        ...
        else
        {
            ...
            eye.SetBlendShapeWeight(13, eyeratio);
            eye_lid.SetBlendShapeWeight(13, eyeratio);
            eyebrow.SetBlendShapeWeight(8, eyeratio);
            ...
            if (mouthratio > 70)
            {
                ...
                eye.SetBlendShapeWeight(13, 0);
                eyebrow.SetBlendShapeWeight(13, 0);
                mouth.SetBlendShapeWeight(33, mouthratio);//張嘴

            }
            else
            {
                mouth.SetBlendShapeWeight(33, mouthratio);//張嘴
                mouth.SetBlendShapeWeight(29, 80); // nomal
